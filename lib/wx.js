...
var wx = module.exports = {
  ...
  Messaging: {
    sendTemplateMsg: function(accessToken, openId, templateId, msgLinkUrl, msgData) {
      ...
      return promisify(request.post)(url, { body: JSON.stringify(requestData) }).then(wx._parseResponse);
    }
  },
